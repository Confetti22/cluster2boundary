...
def remove_layers_with_patterns(layers,name_pattens):
    #use set to avoid duplicated layer_names
    layer_names=_filter_layer_name_with_pattern(layers,name_pattens)
